/*
 * $Header: /home/barad-dur/vision/forsyth/schenney/sced-0.94/c/RCS/edit_menu.c,v 1.0 1997/05/06 20:30:22 schenney Exp $
 *
 * $Log: edit_menu.c,v $
...
static void Edit_Menu_Callback(Widget, XtPointer, XtPointer);
