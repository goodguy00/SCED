/*
 * $Header: /home/barad-dur/vision/forsyth/schenney/sced-0.94/h/RCS/csg.h,v 1.0 1997/05/06 20:41:09 schenney Exp $
 *
 * $Log: csg.h,v $
 * Revision 1.0  1997/05/06 20:41:09  schenney
 * Initial revision
 *
 */
/*
...
extern void         CSG_Delete_Tree(CSGNodePtr, Boolean);
...
extern CSGNodePtr   CSG_Contract_Tree(CSGNodePtr);
extern int          CSG_Count_Tree_Size(CSGNodePtr);
...
extern void CSG_Export_Callback(Widget, XtPointer, XtPointer);
...
extern WireframePtr CSG_Generate_Wireframe(CSGNodePtr, int, Boolean);
